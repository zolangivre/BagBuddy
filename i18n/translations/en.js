export default {
  ...
  cancel_transaction_message:
    "This transaction has been cancelled successfully.",
  ...
  confirmed_completed_message:
    "The transaction has been marked as completed successfully.",
  ...
  confirm_new_request_message:
    "Are you sure you want to send this new reservation request?",
  ...
  content_description_label: "What are you sending?",
  content_description_placeholder: "Describe what the traveller will carry",
  ...
  rating: "Rating",
  account_preview_title: "What other members see",
  account_no_bio: "No bio yet.",
  account_identity_lede: "Your name, and the email you sign in with.",
  account_email_change_note: "Your new email stays unverified until you confirm it.",
  account_current_password: "Current password",
  account_current_password_email_hint:
    "Required to change your email, since you also sign in with it.",
  account_public_title: "Public profile",
  account_public_lede: "Visible to the members you travel with.",
  account_location_placeholder: "Paris, France",
  account_bio_placeholder:
    "Introduce yourself: the routes you usually fly, what you're happy to carry…",
  account_bio_count: "{{count}} / {{max}}",
  account_password_title: "Password",
  account_password_lede: "Pick a password you don't use anywhere else.",
  account_new_password: "New password",
  account_confirm_new_password: "Confirm new password",
  account_save: "Save",
  account_save_password: "Update password",
  account_identity_updated: "Your details have been updated.",
  account_identity_updated_verification:
    "Your details have been updated. A confirmation link was sent to {{email}}.",
  account_password_updated: "Your password has been updated.",
  account_error_invalid_current_password: "Incorrect current password.",
  ...
  filter_search_hint: "Route · date · price · weight",
  filter_search_transactions: "Search your transactions",
  filter_route: "Route",
  filter_from: "From",
  filter_to: "To",
  filter_anywhere: "Anywhere",
  filter_swap: "Swap departure and arrival",
  filter_pick_from: "Departure airport",
  filter_pick_to: "Arrival airport",
  filter_airport_search: "City, airport or code (CDG)",
  filter_popular_airports: "Popular airports",
  filter_no_airport: "No airport matches.",
  filter_departure_date: "Departure date",
  filter_any_date: "Any time",
  filter_exact_date: "Exact date",
  filter_day: "day",
  filter_days: "days",
  filter_days_short: "d",
  filter_price_per_kg: "Price per kilo",
  filter_available_weight: "Available weight",
  filter_reserved_weight: "Reserved weight",
  filter_min: "Min",
  filter_max: "Max",
  filter_min_above_max: "The minimum is above the maximum.",
  filter_status: "Status",
  filter_reset: "Reset",
  filter_clear_all: "Clear all",
  filter_show_listings: "Show {{count}} listings",
  filter_show_listing_one: "Show 1 listing",
  filter_show_none: "No listings match these filters",
  filter_show_count: "Show {{label}}",
  listings_count: "{{count}} listings",
  listings_count_one: "1 listing",
  transactions_count: "{{count}} transactions",
  transactions_count_one: "1 transaction",
  sort_recent: "Most recent",
  sort_earliest_departure: "Departing soonest",
  sort_price_low: "Price: low to high",
  sort_price_high: "Price: high to low",
  sort_weight_high: "Most kilos",
  sort_weight_low: "Fewest kilos",
