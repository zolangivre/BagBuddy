export default {
  ...
  add_your_flight_details:
    "Ajoutez les détails de votre vol et le poids disponible",
  get_requests: "Recevoir des demandes",
  travelers_will_send_you:
    "Les voyageurs vous enverront des demandes de réservation",
  ...
  listing_tips_2:
    "Soyez précis sur le lieu de rencontre et le mode de paiement.",
  listing_tips_3:
  ...
  content_description_label: "Que souhaitez-vous envoyer ?",
  content_description_placeholder: "Décrivez ce que le voyageur transportera",
  ...
  // --- Compte (édition du profil) ---
  rating: "Note",
  account_preview_title: "Ce que voient les autres membres",
  account_no_bio: "Pas encore de bio.",
  account_identity_lede: "Votre nom, et l'email qui vous sert à vous connecter.",
  account_email_change_note:
    "Votre nouvel email restera non vérifié jusqu'à ce que vous le confirmiez.",
  account_current_password: "Mot de passe actuel",
  account_current_password_email_hint:
    "Requis pour changer d'email, qui sert aussi à vous connecter.",
  account_public_title: "Profil public",
  account_public_lede: "Visible par les membres avec qui vous voyagez.",
  account_location_placeholder: "Paris, France",
  account_bio_placeholder:
    "Présentez-vous en quelques mots : vos trajets habituels, ce que vous transportez volontiers…",
  account_bio_count: "{{count}} / {{max}}",
  account_password_title: "Mot de passe",
  account_password_lede: "Choisissez un mot de passe que vous n'utilisez nulle part ailleurs.",
  ...
  account_identity_updated: "Vos informations ont été mises à jour.",
  account_identity_updated_verification:
    "Vos informations ont été mises à jour. Un lien de confirmation a été envoyé à {{email}}.",
  account_password_updated: "Votre mot de passe a été mis à jour.",
  account_error_invalid_current_password: "Mot de passe actuel incorrect.",
  ...
  filter_search_hint: "Trajet · date · prix · poids",
  filter_search_transactions: "Rechercher une transaction",
  filter_route: "Trajet",
  filter_from: "Départ",
  filter_to: "Arrivée",
  filter_anywhere: "Partout",
  filter_swap: "Inverser départ et arrivée",
  filter_pick_from: "Aéroport de départ",
  filter_pick_to: "Aéroport d'arrivée",
  filter_airport_search: "Ville, aéroport ou code (CDG)",
  filter_popular_airports: "Aéroports populaires",
  filter_no_airport: "Aucun aéroport ne correspond.",
  filter_departure_date: "Date de départ",
  filter_any_date: "N'importe quand",
  filter_exact_date: "Date exacte",
  filter_day: "jour",
  filter_days: "jours",
  filter_days_short: "j",
  filter_price_per_kg: "Prix par kilo",
  filter_available_weight: "Poids disponible",
  filter_reserved_weight: "Poids réservé",
  filter_min: "Min",
  filter_max: "Max",
  filter_min_above_max: "Le minimum dépasse le maximum.",
  filter_status: "Statut",
  filter_reset: "Réinitialiser",
  filter_clear_all: "Tout effacer",
  filter_show_listings: "Afficher {{count}} annonces",
  filter_show_listing_one: "Afficher 1 annonce",
  filter_show_none: "Aucune annonce pour ces filtres",
  filter_show_count: "Afficher {{label}}",
  listings_count: "{{count}} annonces",
  listings_count_one: "1 annonce",
  transactions_count: "{{count}} transactions",
  transactions_count_one: "1 transaction",
  sort_recent: "Plus récentes",
  sort_earliest_departure: "Départ le plus proche",
