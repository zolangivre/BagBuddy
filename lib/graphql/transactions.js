...
import { TRANSACTION_FIELDS } from "@/lib/graphql/fragments";
...
/**
 * Filtre ce que les écrans passent encore comme transaction entière : le schéma
 * n'accepte que ces cinq champs, et les autres lèveraient une ValidationError.
 */
export function toTransactionUpdateInput(payload) {
  return {
